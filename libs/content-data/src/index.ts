    ...
    projects: [
      {
        ...
        highlights: [
          ...
          '开发 ASP.NET Core RESTful API 与基于 Blazor 的 Web GUI，并沉淀可复用前端组件能力。',
...
export const bookRecommendations: Record<Locale, BookRecommendation[]> = {
  zh: [
    ...
    },
    {
      ...
      author: 'Scott Meyers',
      category: '系统与底层工程',
      summary: '虽然不是我日常主语言，但它训练了我对语言细节、资源管理和性能边界的敬畏。',
      takeaway: '语言机制背后的成本模型，往往决定系统级软件的行为质量。',
      recommendation: '适合用来提升底层工程直觉，即使主语言不是 C++ 也有帮助。',
      quote: 'C++ 很优美，但它也布满陷阱。',
      featured: false,
    },
    {
    ...
    },
    {
      ...
      title: '程序员的数学',
      category: '系统与底层工程',
      summary: '让我在工程之外补起了更基础的抽象能力。',
      takeaway: '数学训练带来的不是考试能力，而是更清晰的问题建模能力。',
      recommendation: '适合工程实践和抽象思维之间想补桥梁的人。',
      quote: '数学应该放在编程语境里学习，而不是只停留在公式本身。',
      featured: false,
    },
    {
      slug: 'math-for-programmers-2',
      locale: 'zh',
      title: '程序员的数学 2：概率统计',
      category: '系统与底层工程',
      summary: '帮助我更自然地理解风险、分布、采样和数据判断。',
      takeaway: '很多系统稳定性和数据问题，本质上都离不开概率思维。',
      recommendation: '做监控、风控、数据分析或 AI 相关系统时很有帮助。',
      quote: '当系统开始面对不确定性时，概率与统计就不再只是数学题。',
      featured: false,
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      author: 'Scott Meyers',
      category: 'Systems and Low-level Engineering',
      summary: 'A strong reminder that language detail and runtime cost models shape system behavior.',
      takeaway: 'Low-level precision changes how you think about resources, ownership, and performance tradeoffs.',
      recommendation: 'Helpful even if C++ is not your daily language because the engineering discipline transfers.',
      quote: 'C++ is a work of beauty, but it has many pitfalls.',
      featured: false,
    },
    {
      slug: 'unix-network-programming',
    ...
    },
    {
      ...
      category: 'Systems and Low-level Engineering',
      summary: 'Useful for rebuilding abstraction strength beneath everyday engineering decisions.',
      takeaway: 'Math helps most as a modeling tool, not as an academic exercise.',
      recommendation: 'A good bridge if you want stronger reasoning behind system and algorithm choices.',
      quote: 'Mathematics matters when programming stops being syntax and becomes modeling.',
      featured: false,
    },
    {
      slug: 'math-for-programmers-2',
      locale: 'en',
      title: 'Mathematics for Programmers 2: Probability and Statistics',
      category: 'Systems and Low-level Engineering',
      summary: 'Helpful for thinking more clearly about uncertainty, distribution, and data interpretation.',
      takeaway: 'A lot of observability and data work improves when probability thinking becomes more natural.',
      recommendation: 'Especially relevant for monitoring, analytics, and AI-adjacent engineering work.',
      quote: 'Probability becomes essential the moment systems begin to live with uncertainty.',
      featured: false,
    },
    {
      slug: 'google-system-design',
